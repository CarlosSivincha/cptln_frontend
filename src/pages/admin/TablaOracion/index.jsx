...
import { obtenerOracionesPag } from '../../../Api/resOraciones';
    ...
    useEffect(() => {
        const fetch = async (page) => {
            try {
                ...
                const response = await obtenerOracionesPag({ params: { page: Number(page), limit: 10 } });
        ...
        <div className="flex justify-center mt-10">
            <div className="w-full max-w-5xl p-6 rounded-lg shadow-lg bg-gray-50">
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xl font-semibold text-gray-700">Oraciones</h3>
                </div>
                {/* Tabla */}

...
import Vivenciar from "../../../../../assets/VIVENCIAR.jpg";
...
export const EquipandoSantos = () => {
    return(
        <div className="flex flex-col gap-12 lg:gap-16 xl:gap-24 pb-12 xl:pb-24">
            ...
            <ProgramCard color="bg-l_color_v" title="Vivenciar" img={Vivenciar} description="Trabajamos talleres basados en temas de valores con un enfoque bíblico,la enseñanza, también está acompañada de diversas dinámicas, para generar en cada niño y adolescente un aprendizaje significativo." posicion="izquierda"/>
            <ProgramCard color="bg-l_color_v-600" title="Lugar de Fe" img={LugarFe} description="La finalidad es enseñar como actuar frente a una posible situacion de abuso sexual infantil, y de esta manera prevenir en ellos estos tipos de situaciones."/>
...
export default EquipandoSantos